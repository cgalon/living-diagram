...
public class GenerateurDePackageDiagramMermaidDepuisLesImportsTest {
    ...
    public void doitGenererUnDiagrammePourUneSeuleClasse() throws Exception {
        ...
        GenerateurDePackageDiagramMermaidDepuisLesImports generateur = new GenerateurDePackageDiagramMermaidDepuisLesImports(listeDesClassesTrouvees);
